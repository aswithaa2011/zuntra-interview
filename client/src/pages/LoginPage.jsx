...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--cream)] flex">
      {/* Left visual */}
      <div className="hidden lg:flex flex-1 bg-[var(--accent-light)] items-center justify-center relative overflow-hidden">
        <div className="absolute inset-0 opacity-20" style={{backgroundImage: "url('https://images.unsplash.com/photo-1558769132-cb1aea458c5e?w=800')", backgroundSize: "cover", backgroundPosition: "center"}} />
        <div className="relative text-center px-12">
          <h1 className="font-display text-6xl font-light text-[var(--ink)] mb-4 leading-tight">Discover<br /><em>beautiful</em><br />ideas.</h1>
          <p className="text-[var(--muted)] text-sm max-w-xs">Save and organize the visual content that inspires you.</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm fade-up">
          ...
          <h2 className="font-display text-3xl font-light mb-1">Welcome back</h2>
          <p className="text-sm text-[var(--muted)] mb-8">Sign in to continue your visual journey</p>
          ...
          <p className="text-sm text-center text-[var(--muted)] mt-6">
            No account?{" "}
            <Link to="/register" className="text-[var(--ink)] font-medium hover:underline">Sign up free</Link>
          </p>
        </div>
      </div>
    </div>
